...
const [showPopup, setShowPopup] = useState(false);
  ...
  return (
    <>
              ...
              <div className="contact-details">
                <div className="contact-item">
                  ...
                  <div>
                    ...
                    >
                      <p>
                        No. 10, Bajanai Kovil Street, Bharadhidasan Nagar,
      ...
      {/* Success Popup */}
      <div
        className={`success-popup-overlay ${showPopup ? "active" : ""}`}
        onClick={closePopup}
      >
        <div className="success-popup" onClick={(e) => e.stopPropagation()}>
          ...
          <h3 className="success-popup-title">Message Sent Successfully!</h3>
          <p className="success-popup-message">
            Thank you for your interest in Sangeetha Music Academy. Our
            admissions team will contact you soon.
            <br />
            <span className="success-popup-highlight">
              Please check your email
            </span>{" "}
            for a confirmation message.
          </p>
          <button className="success-popup-button" onClick={closePopup}>
            Got It
          </button>
        </div>
      </div>
